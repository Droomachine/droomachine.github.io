...
var PokedexController = /** @class */ (function () {
    function PokedexController(pokedexService) {
        ...
        this.genThree = this.pokedexService.entries.slice(251,386);
    }
