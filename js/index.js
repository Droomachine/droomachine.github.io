...
function topFunction() {
    ...
    function copyToClipboard(text) {
      ...
      function update(){
        ...
        var width = Math.round(checkedBoxes.length/dexNum*10000)/100;
        document.getElementById("myBar").style.width = width + '%';
        document.getElementById("barLabel").innerHTML = "Pokedex Completion: "+ (width * 1  + '%') + " | " + checkedBoxes.length + " / " + dexNum;
      }
